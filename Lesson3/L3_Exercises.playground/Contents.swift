...
let cuteAnimals = Array<CuddlyCreature>()
...
colors.insert("indigo", at: colors.index(of: "blue")! + 1)
//: ### Exercise 4
...
admitted.append(waitingList.remove(at: waitingList.index(of: "Lyla")!))
admitted.append(waitingList.remove(at: waitingList.index(of: "Daniel")!))
//: ### Exercise 7
...
let dic = ["Anchovies" : true, "Coconut" : false, "Cilantro" : false, "Liver" : false]
...
if let baracksDog = presidentialDogs["Barack Obama"] {
    print("Michele Obama walks \(baracksDog) every morning.")
}
//: ### Exercise 13
